...
public interface ActionManagerFactory extends ActionManagerMBean {
     ...
     * @param name the name of the ActionManager. This should be unique across ActionManagers. If there is a duplicate named ActionManager registered a unique name will be assigned.
